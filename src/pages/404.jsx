...
const Error404 = () => {
    return (
        <>
            <div className="bg-white dark:bg-black flex flex-col max-h-screen min-w-fit">
                <Header/>
                <section className="bg-auto flex items-center justify-center h-screen">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                        <div className="mx-auto max-w-screen-sm text-center">
                            ...
                            <p className="mb-4 text-3xl tracking-tight font-bold md:text-4xl dark:text-white">Something&apos;s
                                missing.</p>
